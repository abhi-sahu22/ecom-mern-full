...
const About = () => {
    return (
      <div className="flex flex-col gap-10">
        <div className="flex-col h-[20rem] max-w-[40%] mt-10 px-10 bg-blue-300 rounded-[1rem] shadow-2xl text-slate-700 mx-auto text-center text-2xl font-semibold flex items-center justify-center">
          <h1>About</h1>
